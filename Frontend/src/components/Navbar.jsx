          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className="px-3 py-2 input input-ghost rounded-md bg-transparent dark:bg-slate-800 border dark:border-slate-700">
                ...
                />
                <svg
                  className="h-[1.3em] opacity-50 w-[2em] dark:text-gray-400"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
                  <g
            ...
            <label className="swap swap-rotate">
              ...
              {/* moon icon - visible in light mode, click translates to dark */}
              <svg
              ...
              {/* sun icon - visible in dark mode, click translates to light */}
              <svg
